<x-dashboard-layout>
    ...
    <div class="dashboard-card">
        <form id="filter-form" class="filter" method="GET" action="{{ route('admin-categories.show', ['id'=>$category->id]) }}">
        ...
        <form id="reset-form" method="GET" method="GET" action="{{ route('admin-categories.show', ['id'=>$category->id])}} ">
            ...
            <tbody>
                @foreach($posts as $post)
                    <tr>
                        ...
                        <td>
                            @can('see-users')
                                <a href="{{ route('admin-users.show', ['id'=>$post->user->id])}}">
                                    {{ $post->user->name }}
                                </a>
                            @else
                                {{ $post->user->name }}
